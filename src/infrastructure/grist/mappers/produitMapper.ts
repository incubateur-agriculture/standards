...
export function mapGristProduitToProduit(gristProduit: GristProduit): Produit {
    return {
        ...
        outilsMutualises: cleanGristArray(gristProduit.fields[GRIST.PRODUITS.FIELDS.OUTILS_MUTUALISES] as string[]),
        outilsNonMutualises: cleanGristArray(gristProduit.fields[GRIST.PRODUITS.FIELDS.OUTILS_NON_MUTUALISES] as string[]),
